...
setup_env() {
  ...
  case "$COMPILER" in
    ...
    cce-10.0)
      ...
      module swap craype-{broadwell,x86-rome} # TODO wrong
      echo "IMPL"
      ;;
    gcc-10.2)
      ...
      MAKE_OPTS+=' FLAGS_GNU="-Ofast -ffast-math -ffp-contract=fast -march=skylake-avx512 -funroll-loops"'
      MAKE_OPTS+=' CFLAGS_GNU="-Ofast -ffast-math -ffp-contract=fast -march=skylake-avx512 -funroll-loops"'
      ;;
    llvm-11.0)
